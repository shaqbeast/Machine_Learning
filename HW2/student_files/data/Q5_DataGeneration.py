...
import pandas as pd
np.random.seed(42)
rural_disease_probs = [0.15, 0.12, 0.1, 0.09, 0.08, 0.07, 0.07, 0.06, 0.05,
    0.05] + [0.02] * 10
urban_disease_probs = [0.02] * 10 + [0.15, 0.12, 0.1, 0.09, 0.08, 0.07, 
    0.07, 0.06, 0.05, 0.05]
...
def generate_dataset(n, disease_probs, water_access, sanitation, nutrition):
    data = {'WaterAccess': np.random.binomial(1, water_access, size=n),
